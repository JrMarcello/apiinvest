...
export default () => {
  ...
  router.get(`${INVESTIMENT_BASE_PATH}/pendings`, checkAuth, controller.getPendings)
  ...
  router.put(`${INVESTIMENT_BASE_PATH}/ted-confirmation`, checkAuth, multer.single('file'), controller.tedConfirmation)
  router.put(`${INVESTIMENT_BASE_PATH}/confirmation`, checkAuth, controller.confirmation)
