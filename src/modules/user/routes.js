...
export default () => {
  ...
  router.post(`${USER_BASE_PAH}/login/facebook`, validations.facebookbSign, controller.facebookLogin)
  router.post(`${USER_BASE_PAH}/login/google`, validations.googleSign, controller.googleLogin)
